...
object EndPoints {
    // Server
    private const val SERVER_MAIN = "172.20.1.14"//"172.20.1.19"//"192.168.43.137"//"172.20.1.13"//
    //private const val PATH_MAIN = "http://${SERER_MAIN}/ittus-senalesviales/source/connection/queries/"
